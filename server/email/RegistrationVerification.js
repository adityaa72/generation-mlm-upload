...
const RegistrationVerification = (otp) => {
    ...
    <p style="font-size:20px;line-height:28px;margin:16px 0;margin-bottom:30px">Hey, Just verify your email address to get started with Jamsrworld. Your otp verification is:</p>
...
exports.default = RegistrationVerification;
