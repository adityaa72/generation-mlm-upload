...
const FAMail = (otp, twoFA) => {
    return `  <p style="font-size:36px;line-height:42px;margin:30px 0;color:#1d1c1d;font-weight:700;padding:0">${twoFA ? "Disable" : "Enable"}  2FA</p>
<p style="font-size:20px;line-height:28px;margin:16px 0;margin-bottom:30px">You requested to ${twoFA ? "disable" : "enable"} 2 factor authentication. Your otp code is:</p>
