...
const Transaction = class {
    ...
    static isTransactionId(transactionId) {
        return __awaiter(this, void 0, void 0, function* () {
            const sql = `SELECT transactionId  from ${tables_1.TRANSACTION_TBL} WHERE transactionId = ?`;
    ...
    static createInstance(transactionId, errorText) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = new Transaction(transactionId, errorText);
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isTransactionId = yield Transaction.isTransactionId(this.transactionId);
            if (!isTransactionId)
                throw new errors_1.HttpError(404, errorText || `${this.transactionId} is not a valid  transaction id`);
        });
    }
    getRow() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(0, is_empty_1.default)(this.row))
                return this.row;
            const sql = `SELECT * FROM ${tables_1.TRANSACTION_TBL} WHERE transactionId = ?`;
